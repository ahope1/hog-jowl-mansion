...
130 DATA "IN A DUMBWAITER.",0,25,0,0,43,1,"IN THE TRANSPORTER ROOM OF THE STARSHIP ENTERPRISE.  HEY!
WHERE'S MR. SPOCK?"
...
210 DATA "-- UH OH!  THERE'S A GUY HERE WITH A BIG NOSE AND A SPEECH
IMPEDIMENT.  ARRGH!  IT'S CARL SAGAN.",0,0,0,0,0,0
...
540 A=38: C$=CHR$(93) + STRING$(62,45) + CHR$(94)
550 CLS: PRINT @2,"-": PRINT @579,"WELCOME TO THE ADVENTURE OF HOG JOWL MANSION: VERSION 1.12": PRINT @ 664, "BY JON J. WAPLES"
560 IF A=42 THEN PRINT "YOU HAVE LOST ALL *TREASURES*.": GOTO 2310
570 GOSUB 2000: D$="": E$="": A$="": PRINT @960,;: INPUT "  -------> TELL ME WHAT TO DO"; D$
580 FOR I= 1 TO LEN(D$): IF MID$(D$,I,1)=" " THEN 590 ELSE NEXT: GOTO 600
590 E$= RIGHT$(D$,LEN(D$)-I): A$=LEFT$(E$,3)
600 B$=LEFT$(D$,I-1)
610 FOR I=0 TO 36: IF B$(I)=LEFT$(B$,3) THEN 630 ELSE NEXT
620 PRINT "I DON'T KNOW HOW TO " CHR$(34)B$ CHR$(34)" SOMETHING.": GOTO 560
630 ON I+1 GOTO 650,650,650,650,660,670,680,690,700,960,960,1040,1040,1110,1200,690,710,1230,1320,1350,1360,1410,1490,1500,1540,1570,1600
...
710 IF A$="DUM" AND A=2 THEN IF B=0 THEN A=1: GOTO 950 ELSE PRINT "SOMETHING WON'T FIT.": GOTO 560
720 IF A$="DOO" AND A=3 THEN IF LEFT$(D$(9),2)="UN" THEN A=4: GOTO 950 ELSE 2220
730 IF A$="DOO" AND A=4 THEN IF LEFT$(D$(10),2) ="UN" THEN A=3: GOTO 950 ELSE 2220
740 IF A$="STA" AND A=4 THEN A=24: GOTO 950
750 IF A$="PAS" AND A=23 THEN IF H(21)=1 THEN A=24: GOTO 950 ELSE 2220
760 IF A$="STA" AND A=24 THEN IF H(25)=1 THEN A=4: GOTO 950 ELSE 2220
770 IF A$="DUM" AND A=25 THEN IF B=0 THEN A=21: GOTO 950 ELSE PRINT "SOMETHING WON'T FIT.": GOTO 560
...
810 IF A$="TRE" AND A=31 THEN IF H(38)=1 THEN A=48: GOTO 950 ELSE PRINT "I CAN'T. THE TREE'S TOO UNSTABLE.": GOTO 560
...
850 IF A$="MAN" AND A=36 THEN IF LEFT$(D$(52),4)="DEAD" THEN A=34: GOTO 950 ELSE PRINT "THE DOG WON'T LET ME.": GOTO 560
860 IF A$="GAT" AND A=37 THEN A=36: GOTO 950
870 IF A$="TER" AND A=37 THEN A=38: GOTO 950
880 IF A$="CLO" AND A=39 THEN IF LEFT$(D$(62),2) ="UN" THEN A=40: GOTO 950 ELSE 2220
890 IF A$="TOI" AND A=40 THEN PRINT "AH... I FEEL RELIEVED!": GOTO 560
900 IF A$="DUM" AND A=44 THEN IF B=0 THEN A=43: GOTO 950 ELSE PRINT "SOMETHING WON'T FIT.": GOTO 560
910 IF A$="FLO" AND A=46 THEN IF H(38)=1 THEN A=48: GOTO 950 ELSE PRINT "I CAN'T, THERE'S SOMETHING ON THE OTHER SIDE.": GOTO 560
...
1000 IF B=6 THEN PRINT "I'M CARRYING TOO MUCH. I'M NOT A FORKLIFT!": GOTO 560
...
1080 IF 60-POS(0) < LEN(D$(I)) THEN PRINT
1090 PRINT D$(I)".  ";
...
1140 GOSUB 2000
1150 GOSUB 2200
1160 G=I: PRINT @960,;: INPUT "  -------> TELL ME WHAT TO DO";E$
1170 GOSUB 2200
...
1440 IF I=74 AND A=45 THEN IF D$(74)="CLOSED DOOR" THEN H(75)=1: PRINT "I HEAR A DULL THUD.": D$(74)="OPEN DOOR WITH BRICK WALL BEYOND": GOTO 560 ELSE PRINT "IT'S ALREADY OPEN!": GOTO 560
1450 IF I=78 AND D$(78)="CHEST" THEN H(79)=2: D$(78)="OPEN CHEST": GOTO 1480
1460 IF I=37 AND NOT(D) THEN PRINT "OPENING AN UMBRELLA INSIDE IS BAD LUCK!": PRINT "A SECRET DOOR OPENS BELOW ME... I SLIDE DOWN A RAZOR BLADE": PRINT "INTO A POOL OF ALCOHOL.": GOTO 2280
1470 PRINT "NOTHING HAPPENS.": GOTO 560
1480 PRINT "SOMETHING FALLS OUT.": GOTO 560
1490 GOSUB 2250: GOTO 560
1500 GOSUB 2200
1510 IF I<>7 THEN 2240
1520 FOR I=0 TO 83: IF A(I)=0 AND LEFT$(D$(I),1)="*" THEN A(I)=A: H(I)=0: B=B-1: PRINT"WHIRRR!  BUZZ SAW RIPS THE "D$(I) : PRINT "RIGHT OUT MY HANDS AND DESTROYS IT!": GOTO 560
1530 NEXT: PRINT "BUZZ SAW TURNS ON FOR A MOMENT... THEN STOPS.": GOTO 560
...
1700 IF I=8 OR I=73 THEN PRINT "KABOOM!  MY BODY IS BLOWN INTO SMALL UNRECOGNIZABLE PIECES.": B=B-2: A(I)=A: H(I)=0: A(79)=A: H(79)=0: GOTO 2280
1710 IF I=79 THEN PRINT "MATCH FLARES UP BRIEFLY... THEN DISINTEGRATES.": B=B-1: A(79)=A: H(79)=0: GOTO 560
...
1770 IF I=2 OR I=29 OR I=72 OR I=9 OR I=10 OR I=47 OR I=82 OR I=11 OR I=25 OR I=21 OR I=26 OR I=35 OR I=62 OR I=31 THEN PRINT "THERE'S SOMETHING THERE... MAYBE I SHOULD GO THERE?": GOTO 560
1780 IF I=40 OR I=51 OR I=58 OR I=56 OR I=60 OR I=59 OR I=38 OR I=80 OR I=83 OR I=66 THEN PRINT "THERE'S SOMETHING THERE... MAYBE I SHOULD GO THERE?": GOTO 560
...
1910 IF I=61 THEN PRINT "YOUR MISSION IS TO REPOSSESS THE 13 *TREASURES* OF LORD HOG": PRINT "JOWL AND STORE THEM IN A PREDETERMINED PLACE... GOOD LUCK!": GOTO 560
1920 PRINT "I CAN'T, IT'S ILLEGIBLE.": GOTO 560
1930 ON A GOTO 1950,1950,1960,1960,1950,1950,1950,1950,1950,1950,1950,1950,1950,1950,1950,1950,1950,1950,1950,1950,1950,1950,1970,1970
...
2000 FOR I=2 TO 962 STEP 64: C=PEEK(I+15360): PRINT @(I-2),CHR$(30);:IF C=45 THEN 2010 ELSE NEXT
2010 PRINT CHR$(28)"I AM ";: IF LEFT$(C$(A),1)="*" THEN PRINT RIGHT$(C$(A),LEN(C$(A))-1);: D=-1 ELSE PRINT C$(A);: D=0
2020 FOR I=0 TO 83: IF A(I)=A AND H(I)>0 THEN 2030 ELSE NEXT: GOTO 2090
2030 PRINT "  VISIBLE ITEMS:": PRINT
2040 FOR I=0 TO 83
2050 IF A(I)<>A OR H(I)=0 THEN 2080
2060 IF 60-POS(0)<LEN(D$(I)) THEN PRINT
2070 PRINT D$(I)".  ";
2080 NEXT
2090 PRINT
2100 F$=""
...
2170 IF F$="" THEN 2190
2180 PRINT: PRINT "SOME OBVIOUS EXITS ARE: "F$
2190 PRINT C$;: RETURN
2200 FOR I=0 TO 83: IF A$(I)=LEFT$(E$,3) THEN H=I: IF A(I)=A OR A(I)=0 THEN RETURN
...
2240 PRINT "I MUST BE STUPID, BUT I DON'T UNDERSTAND WHAT YOU MEAN.": GOTO 560
2250 E=0: FOR I=0 TO 83: IF A(I)=40 AND LEFT$(D$(I),1)="*" THEN E=E+1
2260 NEXT: F=E*100/13: PRINT "YOU STORED"E"TREASURES.  ON A SCALE OF 0 TO 100 THAT RATES"STR$(F)".";
2270 IF E=13 THEN PRINT "EXCELLENT!    YOU HAVE COMPLETED THIS ADVENTURE.": GOTO 2310 ELSE PRINT: RETURN
2280 PRINT "I'M DEAD.": PRINT "MY BODY TELEPORTS ELSEWHERE."
2290 PRINT "I SINCERELY HOPE I CAN FIND MY WAY OUT OF HERE.  I DON'T": PRINT "THINK I CAN STAND IT MUCH LONGER!": A=41: GOTO 560
2300 GOSUB 2250
2310 PRINT "THIS ADVENTURE IS OVER."
2320 GOSUB 2000: PRINT @960,;: INPUT "DO YOU WANT TO PLAY THIS ADVENTURE AGAIN";G$
